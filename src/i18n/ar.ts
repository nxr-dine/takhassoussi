...
export const ar: TranslationTree = {
  ...
  developer: {
    title: "المطور",
    description: "تم تطوير منصة تخصصي بواسطة نور الدين بودربالة بهدف تسهيل عملية البحث عن التخصصات الجامعية في الجزائر، وتوفير تجربة سريعة، بسيطة، وحديثة للطلبة.",
    name: "نور الدين بودربالة",
    role: "مهندس برمجيات \u00B7 مطور واجهات أمامية وخلفية \u00B7 طالب هندسة ذكاء اصطناعي",
    portfolio: "الموقع الشخصي",
    github: "جيتهب",
    linkedin: "لينكدإن",
    instagram: "إنستغرام",
    email: "البريد الإلكتروني",
    copyright: "\u00A9 2026 جميع الحقوق محفوظة \u2014 تم التطوير بواسطة نور الدين بودربالة.",
  },
};
